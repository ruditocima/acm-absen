...
// Definisi Logika Aplikasi Absensi
const absensiAppData = () => ({
    isAdminView: false,
...
// Pendaftaran yang aman terhadap race condition (Mendukung pre-init dan post-init Alpine)
if (window.Alpine) {
    window.Alpine.data('absensiApp', absensiAppData);
} else {
